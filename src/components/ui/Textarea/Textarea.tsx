import React, { ClassAttributes, FormEvent, PropsWithChildren, TextareaHTMLAttributes } from 'react';
...
function Textarea({ css = {}, sizeType = 'medium', maxLen, children, ...props }: PropsWithChildren<Props>) {
