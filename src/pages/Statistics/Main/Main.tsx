...
import { wrap, title, swiperFilterCss, leftBtn, rightBtn } from './style';
...
function Main() {
  ...
  return (
    <main css={wrap}>
      <p css={(theme) => ({ ...title(theme), margin: '80px 100px 30px' })}>최근에 푼 문제 복습하기</p>
      <div css={{ position: 'relative', width: '100%', marginBottom: '60px' }}>
        {!isBeginning && (
